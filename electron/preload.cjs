...
contextBridge.exposeInMainWorld("isleOverlay", {
  ...
  probeServer: (url) => ipcRenderer.invoke("server:probe", url),
  openServerSettings: () => ipcRenderer.invoke("server:openSettings"),
  closeServerSettings: () => ipcRenderer.invoke("server:closeSettings"),
